...
import com.example.desy.mytoptwitch.injection.ui.DaggerGameListPresenterComponent;
import com.example.desy.mytoptwitch.injection.ui.GameListPresenterComponent;
import com.example.desy.mytoptwitch.injection.ui.GameListPresenterModule;
...
public class MainActivity extends AppCompatActivity implements GameListContract.View,
    ...
    public void showGameDetails(Game game) {
        ...
        bundle.putParcelable(Game.GAME_TAG, game);
